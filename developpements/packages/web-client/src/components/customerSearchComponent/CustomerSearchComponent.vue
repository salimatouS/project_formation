              ...
              <q-card>
                <q-card-section>
                  <div class="row q-col-gutter-xs q-col-gutter-md-md">
                    ...
                    />
                    <q-input
                      v-model="form.dateDerniereCommandeFrom"
                    ...
                    <q-input
                      v-model="form.dateDerniereCommandeTo"
                      class="col-6 col-md-3"
                      hint="Date comprise"
    ...
    <div>
      ...
      <q-dialog v-model="confirm" persistent>
        <q-card class="bg-cyan-1">
          <q-card-section>
            <q-input v-model="client.chronoClient" label="Code du client" />
            <q-input v-model="client.prenom" id="prenom" label="prenom" />
